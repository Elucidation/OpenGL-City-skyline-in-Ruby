...
class City
  ...
  def initialize size = [1,1]
    ...
    GLUT.InitWindowPosition(250, 150)
    GLUT.InitWindowSize(800, 500)
    ...
    # Lights
    glLightfv(GL_LIGHT0, GL_AMBIENT, BACKGROUND_COLOR)
  ...
  def reshape(width, height)
    ...
    glLoadIdentity
    gluPerspective(45.0, width.to_f / height.to_f, 0.1, 2000.0)
  end
